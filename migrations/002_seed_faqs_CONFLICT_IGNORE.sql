-- Migration: Seed 25 FAQs into Database (SMART - IGNORE CONFLICTS)
-- Purpose: Migrate hardcoded FAQs from page.tsx to Supabase with correct column names
-- Strategy: INSERT ... ON CONFLICT DO NOTHING - skips existing categories/FAQs
...
-- ============================================================================
-- STEP 2: Insert 22 FAQs (SKIP if already exists by unique question+category)
-- ============================================================================
