-- Combined script: Create test users and their enrollments
-- Run this in Supabase SQL Editor

-- First, ensure the test users exist
...
SELECT id, name, email, role, status FROM public.users 
WHERE id IN ('55555555-5555-5555-5555-555555555555', '66666666-6666-6666-6666-666666666666');

-- Now create enrollments for these users
