    ...
    <section className="py-16 sm:py-24 bg-muted dark:bg-slate-dark">
      <div className="container">
        ...
        <div className="flex items-center justify-center space-x-4 mb-8">
          <Label htmlFor="timeline-toggle" className={cn("font-medium dark:text-white", !isPostgraduate ? "text-primary" : "text-muted-foreground")}>
            Undergraduate
          </Label>
          <Switch
            id="timeline-toggle"
            ...
            className="dark:data-[state=unchecked]:bg-slate-700 dark:border dark:border-white"
