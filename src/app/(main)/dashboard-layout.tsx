  ...
  return (
    <SidebarProvider>
      <div className="relative">
        <div className="hidden border-r border-primary/10 bg-gradient-to-b from-primary via-primary/90 to-primary/85 text-primary-foreground lg:flex lg:flex-col lg:fixed lg:left-0 lg:top-0 lg:h-full lg:w-[220px] xl:w-[280px] z-40 dark:from-black dark:via-black/95 dark:to-black/90 dark:border-primary/20 shadow-xl">
        ...
        <div className="lg:ml-[220px] xl:ml-[280px] flex flex-col flex-1 min-h-screen">
            <header className="sticky top-0 z-30 flex h-[60px] items-center gap-4 border-b border-primary/20 bg-gradient-to-r from-primary via-primary/90 to-primary/80 px-4 sm:px-6 dark:from-black dark:via-black/95 dark:to-black/90 shadow-md">
              <MobileSidebar />
            ...
            <main className="flex-1 bg-gradient-to-br from-slate-50 via-white to-blue-50/50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900/50 text-foreground">
