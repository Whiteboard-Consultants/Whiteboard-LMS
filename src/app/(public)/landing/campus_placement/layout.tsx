...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Take the free Career Compass Assessment at whiteboardconsultant.com. It takes 10 minutes. You will receive your report instantly, and a counsellor will reach out to schedule your 1-on-1 debrief within 24 hours.',
  },
] as const;
...
export default function CampusPlacementLayout({
  children,
}: {
