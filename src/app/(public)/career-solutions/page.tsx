    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
          ...
          <div className="rounded-2xl bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-white/60 dark:border-slate-700/60 p-8 md:p-12 mb-12">
            <div className="max-w-3xl">
              ...
              <h2 className="text-xl md:text-2xl text-slate-600 dark:text-slate-300 mb-6">
                Industry-Aligned Internships & Professional Training Programs
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/career-solutions#internships">
      ...
      <section className="py-20 px-4 md:px-6 lg:px-8 bg-white/30 dark:bg-slate-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-foreground/70 dark:text-slate-300/70 text-center mb-12">
            Looking for structured training programs? Check out our professional development courses.
          </p>
            ...
            {[
              {
                ...
                description: 'Upskill with our comprehensive training programs designed for career advancement.',
                icon: Award,
              },
              {
              ...
              },
              {
                ...
                description: 'Join focused workshops on specific skills and emerging technologies.',
                icon: TrendingUp,
              },
            ].map((item, i) => {
              const IconComponent = item.icon;
              return (
                <Link key={i} href="/courses" className="no-underline">
                  <Card variant={(['blue', 'green', 'purple'] as const)[i]} className="h-full hover:shadow-lg transition-all cursor-pointer">
                    <CardContent className="pt-6">
                      <IconComponent className={`h-8 w-8 text-${['blue', 'green', 'purple'][i]}-600 dark:text-${['blue', 'green', 'purple'][i]}-400 mb-4`} />
                      <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">
                        {item.title}
                      </h3>
                      <p className="text-sm text-foreground/60 dark:text-slate-300/60 mb-4">
                        {item.description}
                      </p>
