...
const testimonials = [
  ...
  },
  {
    ...
    quote: 'My eight-week internship at Whiteboard Consultants as an Outreach Oracle and Media Maverick was transformative. Guided by Mr. Navnit Daniel Alley and mentors Nigel Vincent, Prateek Chaudhari, and Shumaila Shaukat Ali, I gained hands-on experience in outreach, content creation, and professional communication. From organizing seminars to mastering LinkedIn optimization, I grew in confidence, skill, and purpose—grateful for the mentorship and AI-driven learning that shaped my career clarity.',
    company: '',
  },
];

const faqs = internshipProgramsFaqs;
