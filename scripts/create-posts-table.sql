-- Create the posts table for the blog system
...
-- Insert some sample posts for testing (optional - remove if not needed)
-- First, let's get a real admin user ID from the users table
DO $$
DECLARE
    admin_user_id UUID;
BEGIN
    ...
    -- If no admin user found, use a default UUID (you'll need to update this manually)
